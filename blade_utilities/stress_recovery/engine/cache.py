...
_CACHE_VERSION = 1
_NPZ_VERSION_KEY = "recovery_cache_version"
...
class RecoveryCache(RecoveryCacheStorage):
    ...
    def eval_delamination_fi(self, beam_resultants: NDArray[np.float64]) -> NDArray[np.float64] | None:
        ...
        consistent with :func:`section_model.engine.interlaminar_recovery.interlaminar_stress_recovery`.
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        d: Dict[str, Any] = {
            _NPZ_VERSION_KEY: np.int32(_CACHE_VERSION),
            "L_rec": self.L_rec,
            "L_iso": self.L_iso,
            "F1": self.F1,
            "F2": self.F2,
        ...
        # UTF-8 names saved as object array for np.savez
