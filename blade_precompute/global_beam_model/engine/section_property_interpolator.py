...
This module is retained for classical/diagnostic workflows and tests.
The main nonlinear beam solve path interpolates station `K7` via
`global_beam_model.engine.interp` and `global_beam_model.k7_interpolation`.
"""
