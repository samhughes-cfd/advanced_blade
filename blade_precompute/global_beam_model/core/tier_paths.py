...
**Tier B — Prescribed section resultants** (:mod:`design_optimisation.engine.beam_k7`)
    ...
    Primary API: :class:`design_optimisation.core.protocols.PrescribedResultantDriver`.
